...
El conjunto de datos **Breast Cancer Gene Expression Profiles** nos proporciona información sobre los perfiles de expresión génica y variables clínicas asociadas a tumores de mama, permitiéndonos explorar de manera estadística la relación entre los subtipos moleculares y distintas características biológicas del tumor.\   
...
data <- read.csv("C:/Users/usuario/Downloads/archive/METABRIC_RNA_Mutation.csv") #cargamos la base de datos
...
Los datos tienen `r nrow(datos_clinicos)` filas y `r ncol(datos_clinicos)` columnas.
...
Usado por @mucakiPredictingOutcomesHormone2017 y @mukherjeeAssociationsGenomicStratification2018
...
datos_grafico_tumor <- datos_clinicos %>%
  ...
  # Paso B: Convertir espacios vacíos ("") a NA
